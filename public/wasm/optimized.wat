(module
 ...
 (data (i32.const 1596) "A\00\00\00\02")
 (export "UInt8Array_ID" (global $src/wasm/lib/index/UInt8Array_ID))
 (export "testMath" (func $src/wasm/lib/index/testMath))
 ...
 (start $~start)
 (func $src/wasm/lib/index/testMath (result f64)
  (local $0 i64)
  (local $1 i64)
  (local $2 i64)
